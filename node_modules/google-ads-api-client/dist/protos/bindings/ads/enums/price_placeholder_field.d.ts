 ...
 */
export declare enum PricePlaceholderFieldEnum_PricePlaceholderField {
    /**
     * Not specified.
     *
...
declare class PricePlaceholderFieldEnum$Type extends MessageType<PricePlaceholderFieldEnum> {
    constructor();
 ...
 */
export declare const PricePlaceholderFieldEnum: PricePlaceholderFieldEnum$Type;
export {};
