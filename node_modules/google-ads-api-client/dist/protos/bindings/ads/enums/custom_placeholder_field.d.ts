 ...
 */
export declare enum CustomPlaceholderFieldEnum_CustomPlaceholderField {
    /**
     * Not specified.
     *
...
declare class CustomPlaceholderFieldEnum$Type extends MessageType<CustomPlaceholderFieldEnum> {
    constructor();
 ...
 */
export declare const CustomPlaceholderFieldEnum: CustomPlaceholderFieldEnum$Type;
export {};
