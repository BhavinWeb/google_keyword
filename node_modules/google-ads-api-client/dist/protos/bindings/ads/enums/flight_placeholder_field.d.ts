...
declare class FlightPlaceholderFieldEnum$Type extends MessageType<FlightPlaceholderFieldEnum> {
    constructor();
 ...
 */
export declare const FlightPlaceholderFieldEnum: FlightPlaceholderFieldEnum$Type;
export {};
