 ...
 */
export declare enum RecommendationTypeEnum_RecommendationType {
    /**
     * Not specified.
     *
...
declare class RecommendationTypeEnum$Type extends MessageType<RecommendationTypeEnum> {
    constructor();
 ...
 */
export declare const RecommendationTypeEnum: RecommendationTypeEnum$Type;
export {};
