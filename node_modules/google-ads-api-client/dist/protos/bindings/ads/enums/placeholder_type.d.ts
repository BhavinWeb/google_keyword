 ...
 */
export declare enum PlaceholderTypeEnum_PlaceholderType {
    /**
     * Not specified.
     *
...
declare class PlaceholderTypeEnum$Type extends MessageType<PlaceholderTypeEnum> {
    constructor();
 ...
 */
export declare const PlaceholderTypeEnum: PlaceholderTypeEnum$Type;
export {};
