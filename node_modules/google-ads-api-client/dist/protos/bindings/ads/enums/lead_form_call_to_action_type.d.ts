 ...
 */
export declare enum LeadFormCallToActionTypeEnum_LeadFormCallToActionType {
    /**
     * Not specified.
     *
...
declare class LeadFormCallToActionTypeEnum$Type extends MessageType<LeadFormCallToActionTypeEnum> {
    constructor();
 ...
 */
export declare const LeadFormCallToActionTypeEnum: LeadFormCallToActionTypeEnum$Type;
export {};
