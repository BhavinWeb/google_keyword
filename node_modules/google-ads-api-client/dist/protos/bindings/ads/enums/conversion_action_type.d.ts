 ...
 */
export declare enum ConversionActionTypeEnum_ConversionActionType {
    /**
     * Not specified.
     *
...
declare class ConversionActionTypeEnum$Type extends MessageType<ConversionActionTypeEnum> {
    constructor();
 ...
 */
export declare const ConversionActionTypeEnum: ConversionActionTypeEnum$Type;
export {};
