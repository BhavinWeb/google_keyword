 ...
 */
export declare enum TravelPlaceholderFieldEnum_TravelPlaceholderField {
    /**
     * Not specified.
     *
...
declare class TravelPlaceholderFieldEnum$Type extends MessageType<TravelPlaceholderFieldEnum> {
    constructor();
 ...
 */
export declare const TravelPlaceholderFieldEnum: TravelPlaceholderFieldEnum$Type;
export {};
