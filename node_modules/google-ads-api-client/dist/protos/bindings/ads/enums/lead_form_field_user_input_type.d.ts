 ...
 */
export declare enum LeadFormFieldUserInputTypeEnum_LeadFormFieldUserInputType {
    /**
     * Not specified.
     *
...
declare class LeadFormFieldUserInputTypeEnum$Type extends MessageType<LeadFormFieldUserInputTypeEnum> {
    constructor();
 ...
 */
export declare const LeadFormFieldUserInputTypeEnum: LeadFormFieldUserInputTypeEnum$Type;
export {};
