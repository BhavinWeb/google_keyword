 ...
 */
export declare enum ResourceLimitTypeEnum_ResourceLimitType {
    /**
...
declare class ResourceLimitTypeEnum$Type extends MessageType<ResourceLimitTypeEnum> {
    constructor();
 ...
 */
export declare const ResourceLimitTypeEnum: ResourceLimitTypeEnum$Type;
export {};
