...
exports.AdGroupExtensionSetting = void 0;
...
class AdGroupExtensionSetting$Type extends runtime_5.MessageType {
    constructor() {
        super("google.ads.googleads.v11.resources.AdGroupExtensionSetting", [
            { no: 1, name: "resource_name", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "google.api.field_behavior": ["IMMUTABLE"], "google.api.resource_reference": { type: "googleads.googleapis.com/AdGroupExtensionSetting" } } },
            ...
            { no: 6, name: "ad_group", kind: "scalar", opt: true, T: 9 /*ScalarType.STRING*/, options: { "google.api.field_behavior": ["IMMUTABLE"], "google.api.resource_reference": { type: "googleads.googleapis.com/AdGroup" } } },
        ...
        ], { "google.api.resource": { type: "googleads.googleapis.com/AdGroupExtensionSetting", pattern: ["customers/{customer_id}/adGroupExtensionSettings/{ad_group_id}~{extension_type}"] } });
    }
    create(value) {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.adGroup !== undefined)
            writer.tag(6, runtime_1.WireType.LengthDelimited).string(message.adGroup);
...
/**
 * @generated MessageType for protobuf message google.ads.googleads.v11.resources.AdGroupExtensionSetting
 */
exports.AdGroupExtensionSetting = new AdGroupExtensionSetting$Type();
//# sourceMappingURL=ad_group_extension_setting.js.map