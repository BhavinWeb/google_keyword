...
exports.CampaignCustomizer = void 0;
...
class CampaignCustomizer$Type extends runtime_5.MessageType {
    constructor() {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* string campaign = 2; */
        if (message.campaign !== "")
            writer.tag(2, runtime_1.WireType.LengthDelimited).string(message.campaign);
 ...
 */
exports.CampaignCustomizer = new CampaignCustomizer$Type();
//# sourceMappingURL=campaign_customizer.js.map