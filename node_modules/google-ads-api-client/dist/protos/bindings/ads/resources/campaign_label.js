...
class CampaignLabel$Type extends runtime_5.MessageType {
    constructor() {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.campaign !== undefined)
            writer.tag(4, runtime_1.WireType.LengthDelimited).string(message.campaign);
 ...
 */
exports.CampaignLabel = new CampaignLabel$Type();
//# sourceMappingURL=campaign_label.js.map