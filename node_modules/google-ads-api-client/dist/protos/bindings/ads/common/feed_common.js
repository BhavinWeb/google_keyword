...
class Money$Type extends runtime_5.MessageType {
    constructor() {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.amountMicros !== undefined)
            writer.tag(4, runtime_1.WireType.Varint).int64(message.amountMicros);
 ...
 */
exports.Money = new Money$Type();
//# sourceMappingURL=feed_common.js.map