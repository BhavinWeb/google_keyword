 ...
 */
export declare enum ExtensionSettingErrorEnum_ExtensionSettingError {
    /**
     * Enum unspecified.
     *
...
declare class ExtensionSettingErrorEnum$Type extends MessageType<ExtensionSettingErrorEnum> {
    constructor();
 ...
 */
export declare const ExtensionSettingErrorEnum: ExtensionSettingErrorEnum$Type;
export {};
