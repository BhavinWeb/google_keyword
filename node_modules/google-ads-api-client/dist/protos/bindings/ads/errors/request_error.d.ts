 ...
 */
export declare enum RequestErrorEnum_RequestError {
    /**
     * Enum unspecified.
     *
...
declare class RequestErrorEnum$Type extends MessageType<RequestErrorEnum> {
    constructor();
 ...
 */
export declare const RequestErrorEnum: RequestErrorEnum$Type;
export {};
