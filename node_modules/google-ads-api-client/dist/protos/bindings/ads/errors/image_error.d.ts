 ...
 */
export declare enum ImageErrorEnum_ImageError {
    /**
     * Enum unspecified.
     *
...
declare class ImageErrorEnum$Type extends MessageType<ImageErrorEnum> {
    constructor();
 ...
 */
export declare const ImageErrorEnum: ImageErrorEnum$Type;
export {};
