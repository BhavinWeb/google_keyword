 ...
 */
export declare enum ConversionValueRuleSetErrorEnum_ConversionValueRuleSetError {
    /**
     * Enum unspecified.
     *
...
declare class ConversionValueRuleSetErrorEnum$Type extends MessageType<ConversionValueRuleSetErrorEnum> {
    constructor();
 ...
 */
export declare const ConversionValueRuleSetErrorEnum: ConversionValueRuleSetErrorEnum$Type;
export {};
