 ...
 */
export declare enum CampaignBudgetErrorEnum_CampaignBudgetError {
    /**
     * Enum unspecified.
     *
...
declare class CampaignBudgetErrorEnum$Type extends MessageType<CampaignBudgetErrorEnum> {
    constructor();
 ...
 */
export declare const CampaignBudgetErrorEnum: CampaignBudgetErrorEnum$Type;
export {};
