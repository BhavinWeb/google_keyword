 ...
 */
export declare enum ExtensionFeedItemErrorEnum_ExtensionFeedItemError {
    /**
     * Enum unspecified.
     *
...
declare class ExtensionFeedItemErrorEnum$Type extends MessageType<ExtensionFeedItemErrorEnum> {
    constructor();
 ...
 */
export declare const ExtensionFeedItemErrorEnum: ExtensionFeedItemErrorEnum$Type;
export {};
