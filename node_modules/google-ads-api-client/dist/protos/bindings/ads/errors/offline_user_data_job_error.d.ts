 ...
 */
export declare enum OfflineUserDataJobErrorEnum_OfflineUserDataJobError {
    /**
     * Enum unspecified.
     *
...
declare class OfflineUserDataJobErrorEnum$Type extends MessageType<OfflineUserDataJobErrorEnum> {
    constructor();
 ...
 */
export declare const OfflineUserDataJobErrorEnum: OfflineUserDataJobErrorEnum$Type;
export {};
