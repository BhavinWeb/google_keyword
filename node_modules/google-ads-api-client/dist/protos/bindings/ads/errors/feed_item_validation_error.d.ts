 ...
 */
export declare enum FeedItemValidationErrorEnum_FeedItemValidationError {
    /**
...
declare class FeedItemValidationErrorEnum$Type extends MessageType<FeedItemValidationErrorEnum> {
    constructor();
 ...
 */
export declare const FeedItemValidationErrorEnum: FeedItemValidationErrorEnum$Type;
export {};
