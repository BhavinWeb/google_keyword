 ...
 */
export declare enum MediaUploadErrorEnum_MediaUploadError {
    /**
     * Enum unspecified.
     *
...
declare class MediaUploadErrorEnum$Type extends MessageType<MediaUploadErrorEnum> {
    constructor();
 ...
 */
export declare const MediaUploadErrorEnum: MediaUploadErrorEnum$Type;
export {};
