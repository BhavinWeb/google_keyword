...
exports.AdGroupExtensionSettingService = exports.MutateAdGroupExtensionSettingResult = exports.MutateAdGroupExtensionSettingsResponse = exports.AdGroupExtensionSettingOperation = exports.MutateAdGroupExtensionSettingsRequest = void 0;
...
const ad_group_extension_setting_1 = require("../resources/ad_group_extension_setting");
const response_content_type_1 = require("../enums/response_content_type");
const field_mask_1 = require("../../google/protobuf/field_mask");
// @generated message type with reflection information, may provide speed optimized methods
class MutateAdGroupExtensionSettingsRequest$Type extends runtime_5.MessageType {
    constructor() {
        super("google.ads.googleads.v11.services.MutateAdGroupExtensionSettingsRequest", [
            ...
            { no: 2, name: "operations", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => exports.AdGroupExtensionSettingOperation, options: { "google.api.field_behavior": ["REQUIRED"] } },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* repeated google.ads.googleads.v11.services.AdGroupExtensionSettingOperation operations */ 2:
                    message.operations.push(exports.AdGroupExtensionSettingOperation.internalBinaryRead(reader, reader.uint32(), options));
                    break;
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let i = 0; i < message.operations.length; i++)
            exports.AdGroupExtensionSettingOperation.internalBinaryWrite(message.operations[i], writer.tag(2, runtime_1.WireType.LengthDelimited).fork(), options).join();
 ...
 */
exports.MutateAdGroupExtensionSettingsRequest = new MutateAdGroupExtensionSettingsRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class AdGroupExtensionSettingOperation$Type extends runtime_5.MessageType {
    constructor() {
        super("google.ads.googleads.v11.services.AdGroupExtensionSettingOperation", [
            ...
            { no: 1, name: "create", kind: "message", oneof: "operation", T: () => ad_group_extension_setting_1.AdGroupExtensionSetting },
            { no: 2, name: "update", kind: "message", oneof: "operation", T: () => ad_group_extension_setting_1.AdGroupExtensionSetting },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* google.ads.googleads.v11.resources.AdGroupExtensionSetting create */ 1:
                    message.operation = {
                        oneofKind: "create",
                        create: ad_group_extension_setting_1.AdGroupExtensionSetting.internalBinaryRead(reader, reader.uint32(), options, message.operation.create)
                    };
                    break;
                case /* google.ads.googleads.v11.resources.AdGroupExtensionSetting update */ 2:
                    message.operation = {
                        oneofKind: "update",
                        update: ad_group_extension_setting_1.AdGroupExtensionSetting.internalBinaryRead(reader, reader.uint32(), options, message.operation.update)
                    };
                    break;
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.operation.oneofKind === "create")
            ad_group_extension_setting_1.AdGroupExtensionSetting.internalBinaryWrite(message.operation.create, writer.tag(1, runtime_1.WireType.LengthDelimited).fork(), options).join();
        /* google.ads.googleads.v11.resources.AdGroupExtensionSetting update = 2; */
        if (message.operation.oneofKind === "update")
            ad_group_extension_setting_1.AdGroupExtensionSetting.internalBinaryWrite(message.operation.update, writer.tag(2, runtime_1.WireType.LengthDelimited).fork(), options).join();
        /* string remove = 3; */
 ...
 */
exports.AdGroupExtensionSettingOperation = new AdGroupExtensionSettingOperation$Type();
// @generated message type with reflection information, may provide speed optimized methods
class MutateAdGroupExtensionSettingsResponse$Type extends runtime_5.MessageType {
    constructor() {
        super("google.ads.googleads.v11.services.MutateAdGroupExtensionSettingsResponse", [
            ...
            { no: 2, name: "results", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => exports.MutateAdGroupExtensionSettingResult }
        ]);
    }
    create(value) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* repeated google.ads.googleads.v11.services.MutateAdGroupExtensionSettingResult results */ 2:
                    message.results.push(exports.MutateAdGroupExtensionSettingResult.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let i = 0; i < message.results.length; i++)
            exports.MutateAdGroupExtensionSettingResult.internalBinaryWrite(message.results[i], writer.tag(2, runtime_1.WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
 ...
 */
exports.MutateAdGroupExtensionSettingsResponse = new MutateAdGroupExtensionSettingsResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class MutateAdGroupExtensionSettingResult$Type extends runtime_5.MessageType {
    constructor() {
        super("google.ads.googleads.v11.services.MutateAdGroupExtensionSettingResult", [
            ...
            { no: 2, name: "ad_group_extension_setting", kind: "message", T: () => ad_group_extension_setting_1.AdGroupExtensionSetting }
        ]);
    }
    create(value) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* google.ads.googleads.v11.resources.AdGroupExtensionSetting ad_group_extension_setting */ 2:
                    message.adGroupExtensionSetting = ad_group_extension_setting_1.AdGroupExtensionSetting.internalBinaryRead(reader, reader.uint32(), options, message.adGroupExtensionSetting);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.adGroupExtensionSetting)
            ad_group_extension_setting_1.AdGroupExtensionSetting.internalBinaryWrite(message.adGroupExtensionSetting, writer.tag(2, runtime_1.WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
 ...
 */
exports.MutateAdGroupExtensionSettingResult = new MutateAdGroupExtensionSettingResult$Type();
/**
 * @generated ServiceType for protobuf service google.ads.googleads.v11.services.AdGroupExtensionSettingService
 */
exports.AdGroupExtensionSettingService = new runtime_rpc_1.ServiceType("google.ads.googleads.v11.services.AdGroupExtensionSettingService", [
    { name: "MutateAdGroupExtensionSettings", options: { "google.api.http": { post: "/v11/customers/{customer_id=*}/adGroupExtensionSettings:mutate", body: "*" }, "google.api.method_signature": ["customer_id,operations"] }, I: exports.MutateAdGroupExtensionSettingsRequest, O: exports.MutateAdGroupExtensionSettingsResponse }
], { "google.api.default_host": "googleads.googleapis.com", "google.api.oauth_scopes": "https://www.googleapis.com/auth/adwords" });
//# sourceMappingURL=ad_group_extension_setting_service.js.map