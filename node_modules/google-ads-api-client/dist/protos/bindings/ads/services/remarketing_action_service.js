...
exports.RemarketingActionService = exports.MutateRemarketingActionResult = exports.MutateRemarketingActionsResponse = exports.RemarketingActionOperation = exports.MutateRemarketingActionsRequest = void 0;
...
const remarketing_action_1 = require("../resources/remarketing_action");
const field_mask_1 = require("../../google/protobuf/field_mask");
// @generated message type with reflection information, may provide speed optimized methods
class MutateRemarketingActionsRequest$Type extends runtime_5.MessageType {
    constructor() {
        super("google.ads.googleads.v11.services.MutateRemarketingActionsRequest", [
            ...
            { no: 2, name: "operations", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => exports.RemarketingActionOperation, options: { "google.api.field_behavior": ["REQUIRED"] } },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* repeated google.ads.googleads.v11.services.RemarketingActionOperation operations */ 2:
                    message.operations.push(exports.RemarketingActionOperation.internalBinaryRead(reader, reader.uint32(), options));
                    break;
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let i = 0; i < message.operations.length; i++)
            exports.RemarketingActionOperation.internalBinaryWrite(message.operations[i], writer.tag(2, runtime_1.WireType.LengthDelimited).fork(), options).join();
 ...
 */
exports.MutateRemarketingActionsRequest = new MutateRemarketingActionsRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class RemarketingActionOperation$Type extends runtime_5.MessageType {
    constructor() {
        super("google.ads.googleads.v11.services.RemarketingActionOperation", [
            ...
            { no: 1, name: "create", kind: "message", oneof: "operation", T: () => remarketing_action_1.RemarketingAction },
            { no: 2, name: "update", kind: "message", oneof: "operation", T: () => remarketing_action_1.RemarketingAction }
        ]);
    }
    create(value) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* google.ads.googleads.v11.resources.RemarketingAction create */ 1:
                    message.operation = {
                        oneofKind: "create",
                        create: remarketing_action_1.RemarketingAction.internalBinaryRead(reader, reader.uint32(), options, message.operation.create)
                    };
                    break;
                case /* google.ads.googleads.v11.resources.RemarketingAction update */ 2:
                    message.operation = {
                        oneofKind: "update",
                        update: remarketing_action_1.RemarketingAction.internalBinaryRead(reader, reader.uint32(), options, message.operation.update)
                    };
                    break;
                default:
                    let u = options.readUnknownField;
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.operation.oneofKind === "create")
            remarketing_action_1.RemarketingAction.internalBinaryWrite(message.operation.create, writer.tag(1, runtime_1.WireType.LengthDelimited).fork(), options).join();
        /* google.ads.googleads.v11.resources.RemarketingAction update = 2; */
        if (message.operation.oneofKind === "update")
            remarketing_action_1.RemarketingAction.internalBinaryWrite(message.operation.update, writer.tag(2, runtime_1.WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
 ...
 */
exports.RemarketingActionOperation = new RemarketingActionOperation$Type();
// @generated message type with reflection information, may provide speed optimized methods
class MutateRemarketingActionsResponse$Type extends runtime_5.MessageType {
    constructor() {
        super("google.ads.googleads.v11.services.MutateRemarketingActionsResponse", [
            ...
            { no: 2, name: "results", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => exports.MutateRemarketingActionResult }
        ]);
    }
    create(value) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* repeated google.ads.googleads.v11.services.MutateRemarketingActionResult results */ 2:
                    message.results.push(exports.MutateRemarketingActionResult.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let i = 0; i < message.results.length; i++)
            exports.MutateRemarketingActionResult.internalBinaryWrite(message.results[i], writer.tag(2, runtime_1.WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
 ...
 */
exports.MutateRemarketingActionsResponse = new MutateRemarketingActionsResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class MutateRemarketingActionResult$Type extends runtime_5.MessageType {
    constructor() {
 ...
 */
exports.MutateRemarketingActionResult = new MutateRemarketingActionResult$Type();
/**
 * @generated ServiceType for protobuf service google.ads.googleads.v11.services.RemarketingActionService
 */
exports.RemarketingActionService = new runtime_rpc_1.ServiceType("google.ads.googleads.v11.services.RemarketingActionService", [
    { name: "MutateRemarketingActions", options: { "google.api.http": { post: "/v11/customers/{customer_id=*}/remarketingActions:mutate", body: "*" }, "google.api.method_signature": ["customer_id,operations"] }, I: exports.MutateRemarketingActionsRequest, O: exports.MutateRemarketingActionsResponse }
], { "google.api.default_host": "googleads.googleapis.com", "google.api.oauth_scopes": "https://www.googleapis.com/auth/adwords" });
//# sourceMappingURL=remarketing_action_service.js.map