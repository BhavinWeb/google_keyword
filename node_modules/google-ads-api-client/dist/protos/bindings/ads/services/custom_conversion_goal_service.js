...
exports.CustomConversionGoalService = exports.MutateCustomConversionGoalResult = exports.MutateCustomConversionGoalsResponse = exports.CustomConversionGoalOperation = exports.MutateCustomConversionGoalsRequest = void 0;
...
const custom_conversion_goal_1 = require("../resources/custom_conversion_goal");
const field_mask_1 = require("../../google/protobuf/field_mask");
const response_content_type_1 = require("../enums/response_content_type");
// @generated message type with reflection information, may provide speed optimized methods
class MutateCustomConversionGoalsRequest$Type extends runtime_5.MessageType {
    constructor() {
        super("google.ads.googleads.v11.services.MutateCustomConversionGoalsRequest", [
            ...
            { no: 2, name: "operations", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => exports.CustomConversionGoalOperation, options: { "google.api.field_behavior": ["REQUIRED"] } },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* repeated google.ads.googleads.v11.services.CustomConversionGoalOperation operations */ 2:
                    message.operations.push(exports.CustomConversionGoalOperation.internalBinaryRead(reader, reader.uint32(), options));
                    break;
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let i = 0; i < message.operations.length; i++)
            exports.CustomConversionGoalOperation.internalBinaryWrite(message.operations[i], writer.tag(2, runtime_1.WireType.LengthDelimited).fork(), options).join();
 ...
 */
exports.MutateCustomConversionGoalsRequest = new MutateCustomConversionGoalsRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class CustomConversionGoalOperation$Type extends runtime_5.MessageType {
    constructor() {
        super("google.ads.googleads.v11.services.CustomConversionGoalOperation", [
            ...
            { no: 1, name: "create", kind: "message", oneof: "operation", T: () => custom_conversion_goal_1.CustomConversionGoal },
            { no: 2, name: "update", kind: "message", oneof: "operation", T: () => custom_conversion_goal_1.CustomConversionGoal },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* google.ads.googleads.v11.resources.CustomConversionGoal create */ 1:
                    message.operation = {
                        oneofKind: "create",
                        create: custom_conversion_goal_1.CustomConversionGoal.internalBinaryRead(reader, reader.uint32(), options, message.operation.create)
                    };
                    break;
                case /* google.ads.googleads.v11.resources.CustomConversionGoal update */ 2:
                    message.operation = {
                        oneofKind: "update",
                        update: custom_conversion_goal_1.CustomConversionGoal.internalBinaryRead(reader, reader.uint32(), options, message.operation.update)
                    };
                    break;
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.operation.oneofKind === "create")
            custom_conversion_goal_1.CustomConversionGoal.internalBinaryWrite(message.operation.create, writer.tag(1, runtime_1.WireType.LengthDelimited).fork(), options).join();
        /* google.ads.googleads.v11.resources.CustomConversionGoal update = 2; */
        if (message.operation.oneofKind === "update")
            custom_conversion_goal_1.CustomConversionGoal.internalBinaryWrite(message.operation.update, writer.tag(2, runtime_1.WireType.LengthDelimited).fork(), options).join();
        /* string remove = 3; */
 ...
 */
exports.CustomConversionGoalOperation = new CustomConversionGoalOperation$Type();
// @generated message type with reflection information, may provide speed optimized methods
class MutateCustomConversionGoalsResponse$Type extends runtime_5.MessageType {
    constructor() {
        super("google.ads.googleads.v11.services.MutateCustomConversionGoalsResponse", [
            { no: 1, name: "results", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => exports.MutateCustomConversionGoalResult }
        ]);
    }
    create(value) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* repeated google.ads.googleads.v11.services.MutateCustomConversionGoalResult results */ 1:
                    message.results.push(exports.MutateCustomConversionGoalResult.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let i = 0; i < message.results.length; i++)
            exports.MutateCustomConversionGoalResult.internalBinaryWrite(message.results[i], writer.tag(1, runtime_1.WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
 ...
 */
exports.MutateCustomConversionGoalsResponse = new MutateCustomConversionGoalsResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class MutateCustomConversionGoalResult$Type extends runtime_5.MessageType {
    constructor() {
        super("google.ads.googleads.v11.services.MutateCustomConversionGoalResult", [
            ...
            { no: 2, name: "custom_conversion_goal", kind: "message", T: () => custom_conversion_goal_1.CustomConversionGoal }
        ]);
    }
    create(value) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* google.ads.googleads.v11.resources.CustomConversionGoal custom_conversion_goal */ 2:
                    message.customConversionGoal = custom_conversion_goal_1.CustomConversionGoal.internalBinaryRead(reader, reader.uint32(), options, message.customConversionGoal);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.customConversionGoal)
            custom_conversion_goal_1.CustomConversionGoal.internalBinaryWrite(message.customConversionGoal, writer.tag(2, runtime_1.WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
 ...
 */
exports.MutateCustomConversionGoalResult = new MutateCustomConversionGoalResult$Type();
/**
 * @generated ServiceType for protobuf service google.ads.googleads.v11.services.CustomConversionGoalService
 */
exports.CustomConversionGoalService = new runtime_rpc_1.ServiceType("google.ads.googleads.v11.services.CustomConversionGoalService", [
    { name: "MutateCustomConversionGoals", options: { "google.api.http": { post: "/v11/customers/{customer_id=*}/customConversionGoals:mutate", body: "*" }, "google.api.method_signature": ["customer_id,operations"] }, I: exports.MutateCustomConversionGoalsRequest, O: exports.MutateCustomConversionGoalsResponse }
], { "google.api.default_host": "googleads.googleapis.com", "google.api.oauth_scopes": "https://www.googleapis.com/auth/adwords" });
//# sourceMappingURL=custom_conversion_goal_service.js.map