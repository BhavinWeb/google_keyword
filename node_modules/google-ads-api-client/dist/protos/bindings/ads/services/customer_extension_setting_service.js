...
exports.CustomerExtensionSettingService = exports.MutateCustomerExtensionSettingResult = exports.MutateCustomerExtensionSettingsResponse = exports.CustomerExtensionSettingOperation = exports.MutateCustomerExtensionSettingsRequest = void 0;
...
const customer_extension_setting_1 = require("../resources/customer_extension_setting");
const field_mask_1 = require("../../google/protobuf/field_mask");
const response_content_type_1 = require("../enums/response_content_type");
// @generated message type with reflection information, may provide speed optimized methods
class MutateCustomerExtensionSettingsRequest$Type extends runtime_5.MessageType {
    constructor() {
        super("google.ads.googleads.v11.services.MutateCustomerExtensionSettingsRequest", [
            ...
            { no: 2, name: "operations", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => exports.CustomerExtensionSettingOperation, options: { "google.api.field_behavior": ["REQUIRED"] } },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* repeated google.ads.googleads.v11.services.CustomerExtensionSettingOperation operations */ 2:
                    message.operations.push(exports.CustomerExtensionSettingOperation.internalBinaryRead(reader, reader.uint32(), options));
                    break;
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let i = 0; i < message.operations.length; i++)
            exports.CustomerExtensionSettingOperation.internalBinaryWrite(message.operations[i], writer.tag(2, runtime_1.WireType.LengthDelimited).fork(), options).join();
 ...
 */
exports.MutateCustomerExtensionSettingsRequest = new MutateCustomerExtensionSettingsRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class CustomerExtensionSettingOperation$Type extends runtime_5.MessageType {
    constructor() {
        super("google.ads.googleads.v11.services.CustomerExtensionSettingOperation", [
            ...
            { no: 1, name: "create", kind: "message", oneof: "operation", T: () => customer_extension_setting_1.CustomerExtensionSetting },
            { no: 2, name: "update", kind: "message", oneof: "operation", T: () => customer_extension_setting_1.CustomerExtensionSetting },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* google.ads.googleads.v11.resources.CustomerExtensionSetting create */ 1:
                    message.operation = {
                        oneofKind: "create",
                        create: customer_extension_setting_1.CustomerExtensionSetting.internalBinaryRead(reader, reader.uint32(), options, message.operation.create)
                    };
                    break;
                case /* google.ads.googleads.v11.resources.CustomerExtensionSetting update */ 2:
                    message.operation = {
                        oneofKind: "update",
                        update: customer_extension_setting_1.CustomerExtensionSetting.internalBinaryRead(reader, reader.uint32(), options, message.operation.update)
                    };
                    break;
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.operation.oneofKind === "create")
            customer_extension_setting_1.CustomerExtensionSetting.internalBinaryWrite(message.operation.create, writer.tag(1, runtime_1.WireType.LengthDelimited).fork(), options).join();
        /* google.ads.googleads.v11.resources.CustomerExtensionSetting update = 2; */
        if (message.operation.oneofKind === "update")
            customer_extension_setting_1.CustomerExtensionSetting.internalBinaryWrite(message.operation.update, writer.tag(2, runtime_1.WireType.LengthDelimited).fork(), options).join();
        /* string remove = 3; */
 ...
 */
exports.CustomerExtensionSettingOperation = new CustomerExtensionSettingOperation$Type();
// @generated message type with reflection information, may provide speed optimized methods
class MutateCustomerExtensionSettingsResponse$Type extends runtime_5.MessageType {
    constructor() {
        super("google.ads.googleads.v11.services.MutateCustomerExtensionSettingsResponse", [
            ...
            { no: 2, name: "results", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => exports.MutateCustomerExtensionSettingResult }
        ]);
    }
    create(value) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* repeated google.ads.googleads.v11.services.MutateCustomerExtensionSettingResult results */ 2:
                    message.results.push(exports.MutateCustomerExtensionSettingResult.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let i = 0; i < message.results.length; i++)
            exports.MutateCustomerExtensionSettingResult.internalBinaryWrite(message.results[i], writer.tag(2, runtime_1.WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
 ...
 */
exports.MutateCustomerExtensionSettingsResponse = new MutateCustomerExtensionSettingsResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class MutateCustomerExtensionSettingResult$Type extends runtime_5.MessageType {
    constructor() {
        super("google.ads.googleads.v11.services.MutateCustomerExtensionSettingResult", [
            ...
            { no: 2, name: "customer_extension_setting", kind: "message", T: () => customer_extension_setting_1.CustomerExtensionSetting }
        ]);
    }
    create(value) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* google.ads.googleads.v11.resources.CustomerExtensionSetting customer_extension_setting */ 2:
                    message.customerExtensionSetting = customer_extension_setting_1.CustomerExtensionSetting.internalBinaryRead(reader, reader.uint32(), options, message.customerExtensionSetting);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.customerExtensionSetting)
            customer_extension_setting_1.CustomerExtensionSetting.internalBinaryWrite(message.customerExtensionSetting, writer.tag(2, runtime_1.WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
 ...
 */
exports.MutateCustomerExtensionSettingResult = new MutateCustomerExtensionSettingResult$Type();
/**
 * @generated ServiceType for protobuf service google.ads.googleads.v11.services.CustomerExtensionSettingService
 */
exports.CustomerExtensionSettingService = new runtime_rpc_1.ServiceType("google.ads.googleads.v11.services.CustomerExtensionSettingService", [
    { name: "MutateCustomerExtensionSettings", options: { "google.api.http": { post: "/v11/customers/{customer_id=*}/customerExtensionSettings:mutate", body: "*" }, "google.api.method_signature": ["customer_id,operations"] }, I: exports.MutateCustomerExtensionSettingsRequest, O: exports.MutateCustomerExtensionSettingsResponse }
], { "google.api.default_host": "googleads.googleapis.com", "google.api.oauth_scopes": "https://www.googleapis.com/auth/adwords" });
//# sourceMappingURL=customer_extension_setting_service.js.map