...
exports.CampaignService = exports.MutateCampaignResult = exports.MutateCampaignsResponse = exports.CampaignOperation = exports.MutateCampaignsRequest = void 0;
...
class MutateCampaignsRequest$Type extends runtime_5.MessageType {
    constructor() {
        super("google.ads.googleads.v11.services.MutateCampaignsRequest", [
            ...
            { no: 2, name: "operations", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => exports.CampaignOperation, options: { "google.api.field_behavior": ["REQUIRED"] } },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* repeated google.ads.googleads.v11.services.CampaignOperation operations */ 2:
                    message.operations.push(exports.CampaignOperation.internalBinaryRead(reader, reader.uint32(), options));
                    break;
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let i = 0; i < message.operations.length; i++)
            exports.CampaignOperation.internalBinaryWrite(message.operations[i], writer.tag(2, runtime_1.WireType.LengthDelimited).fork(), options).join();
 ...
 */
exports.MutateCampaignsRequest = new MutateCampaignsRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class CampaignOperation$Type extends runtime_5.MessageType {
    constructor() {
        super("google.ads.googleads.v11.services.CampaignOperation", [
            { no: 4, name: "update_mask", kind: "message", T: () => field_mask_1.FieldMask },
            { no: 1, name: "create", kind: "message", oneof: "operation", T: () => campaign_1.Campaign },
            { no: 2, name: "update", kind: "message", oneof: "operation", T: () => campaign_1.Campaign },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* google.ads.googleads.v11.resources.Campaign create */ 1:
                    message.operation = {
                        oneofKind: "create",
                        create: campaign_1.Campaign.internalBinaryRead(reader, reader.uint32(), options, message.operation.create)
                    };
                    break;
                case /* google.ads.googleads.v11.resources.Campaign update */ 2:
                    message.operation = {
                        oneofKind: "update",
                        update: campaign_1.Campaign.internalBinaryRead(reader, reader.uint32(), options, message.operation.update)
                    };
                    break;
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.operation.oneofKind === "create")
            campaign_1.Campaign.internalBinaryWrite(message.operation.create, writer.tag(1, runtime_1.WireType.LengthDelimited).fork(), options).join();
        /* google.ads.googleads.v11.resources.Campaign update = 2; */
        if (message.operation.oneofKind === "update")
            campaign_1.Campaign.internalBinaryWrite(message.operation.update, writer.tag(2, runtime_1.WireType.LengthDelimited).fork(), options).join();
        /* string remove = 3; */
 ...
 */
exports.CampaignOperation = new CampaignOperation$Type();
// @generated message type with reflection information, may provide speed optimized methods
class MutateCampaignsResponse$Type extends runtime_5.MessageType {
    constructor() {
        super("google.ads.googleads.v11.services.MutateCampaignsResponse", [
            ...
            { no: 2, name: "results", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => exports.MutateCampaignResult }
        ]);
    }
    create(value) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* repeated google.ads.googleads.v11.services.MutateCampaignResult results */ 2:
                    message.results.push(exports.MutateCampaignResult.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let i = 0; i < message.results.length; i++)
            exports.MutateCampaignResult.internalBinaryWrite(message.results[i], writer.tag(2, runtime_1.WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
 ...
 */
exports.MutateCampaignsResponse = new MutateCampaignsResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class MutateCampaignResult$Type extends runtime_5.MessageType {
    constructor() {
        super("google.ads.googleads.v11.services.MutateCampaignResult", [
            ...
            { no: 2, name: "campaign", kind: "message", T: () => campaign_1.Campaign }
        ]);
    }
    create(value) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* google.ads.googleads.v11.resources.Campaign campaign */ 2:
                    message.campaign = campaign_1.Campaign.internalBinaryRead(reader, reader.uint32(), options, message.campaign);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.campaign)
            campaign_1.Campaign.internalBinaryWrite(message.campaign, writer.tag(2, runtime_1.WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
 ...
 */
exports.MutateCampaignResult = new MutateCampaignResult$Type();
/**
 * @generated ServiceType for protobuf service google.ads.googleads.v11.services.CampaignService
 */
exports.CampaignService = new runtime_rpc_1.ServiceType("google.ads.googleads.v11.services.CampaignService", [
    { name: "MutateCampaigns", options: { "google.api.http": { post: "/v11/customers/{customer_id=*}/campaigns:mutate", body: "*" }, "google.api.method_signature": ["customer_id,operations"] }, I: exports.MutateCampaignsRequest, O: exports.MutateCampaignsResponse }
], { "google.api.default_host": "googleads.googleapis.com", "google.api.oauth_scopes": "https://www.googleapis.com/auth/adwords" });
//# sourceMappingURL=campaign_service.js.map