...
exports.KeywordPlanAdGroupService = exports.MutateKeywordPlanAdGroupResult = exports.MutateKeywordPlanAdGroupsResponse = exports.KeywordPlanAdGroupOperation = exports.MutateKeywordPlanAdGroupsRequest = void 0;
...
const keyword_plan_ad_group_1 = require("../resources/keyword_plan_ad_group");
const field_mask_1 = require("../../google/protobuf/field_mask");
// @generated message type with reflection information, may provide speed optimized methods
class MutateKeywordPlanAdGroupsRequest$Type extends runtime_5.MessageType {
    constructor() {
        super("google.ads.googleads.v11.services.MutateKeywordPlanAdGroupsRequest", [
            ...
            { no: 2, name: "operations", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => exports.KeywordPlanAdGroupOperation, options: { "google.api.field_behavior": ["REQUIRED"] } },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* repeated google.ads.googleads.v11.services.KeywordPlanAdGroupOperation operations */ 2:
                    message.operations.push(exports.KeywordPlanAdGroupOperation.internalBinaryRead(reader, reader.uint32(), options));
                    break;
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let i = 0; i < message.operations.length; i++)
            exports.KeywordPlanAdGroupOperation.internalBinaryWrite(message.operations[i], writer.tag(2, runtime_1.WireType.LengthDelimited).fork(), options).join();
 ...
 */
exports.MutateKeywordPlanAdGroupsRequest = new MutateKeywordPlanAdGroupsRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class KeywordPlanAdGroupOperation$Type extends runtime_5.MessageType {
    constructor() {
        super("google.ads.googleads.v11.services.KeywordPlanAdGroupOperation", [
            ...
            { no: 1, name: "create", kind: "message", oneof: "operation", T: () => keyword_plan_ad_group_1.KeywordPlanAdGroup },
            { no: 2, name: "update", kind: "message", oneof: "operation", T: () => keyword_plan_ad_group_1.KeywordPlanAdGroup },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* google.ads.googleads.v11.resources.KeywordPlanAdGroup create */ 1:
                    message.operation = {
                        oneofKind: "create",
                        create: keyword_plan_ad_group_1.KeywordPlanAdGroup.internalBinaryRead(reader, reader.uint32(), options, message.operation.create)
                    };
                    break;
                case /* google.ads.googleads.v11.resources.KeywordPlanAdGroup update */ 2:
                    message.operation = {
                        oneofKind: "update",
                        update: keyword_plan_ad_group_1.KeywordPlanAdGroup.internalBinaryRead(reader, reader.uint32(), options, message.operation.update)
                    };
                    break;
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.operation.oneofKind === "create")
            keyword_plan_ad_group_1.KeywordPlanAdGroup.internalBinaryWrite(message.operation.create, writer.tag(1, runtime_1.WireType.LengthDelimited).fork(), options).join();
        /* google.ads.googleads.v11.resources.KeywordPlanAdGroup update = 2; */
        if (message.operation.oneofKind === "update")
            keyword_plan_ad_group_1.KeywordPlanAdGroup.internalBinaryWrite(message.operation.update, writer.tag(2, runtime_1.WireType.LengthDelimited).fork(), options).join();
        /* string remove = 3; */
 ...
 */
exports.KeywordPlanAdGroupOperation = new KeywordPlanAdGroupOperation$Type();
// @generated message type with reflection information, may provide speed optimized methods
class MutateKeywordPlanAdGroupsResponse$Type extends runtime_5.MessageType {
    constructor() {
        super("google.ads.googleads.v11.services.MutateKeywordPlanAdGroupsResponse", [
            ...
            { no: 2, name: "results", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => exports.MutateKeywordPlanAdGroupResult }
        ]);
    }
    create(value) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* repeated google.ads.googleads.v11.services.MutateKeywordPlanAdGroupResult results */ 2:
                    message.results.push(exports.MutateKeywordPlanAdGroupResult.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let i = 0; i < message.results.length; i++)
            exports.MutateKeywordPlanAdGroupResult.internalBinaryWrite(message.results[i], writer.tag(2, runtime_1.WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
 ...
 */
exports.MutateKeywordPlanAdGroupsResponse = new MutateKeywordPlanAdGroupsResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class MutateKeywordPlanAdGroupResult$Type extends runtime_5.MessageType {
    constructor() {
 ...
 */
exports.MutateKeywordPlanAdGroupResult = new MutateKeywordPlanAdGroupResult$Type();
/**
 * @generated ServiceType for protobuf service google.ads.googleads.v11.services.KeywordPlanAdGroupService
 */
exports.KeywordPlanAdGroupService = new runtime_rpc_1.ServiceType("google.ads.googleads.v11.services.KeywordPlanAdGroupService", [
    { name: "MutateKeywordPlanAdGroups", options: { "google.api.http": { post: "/v11/customers/{customer_id=*}/keywordPlanAdGroups:mutate", body: "*" }, "google.api.method_signature": ["customer_id,operations"] }, I: exports.MutateKeywordPlanAdGroupsRequest, O: exports.MutateKeywordPlanAdGroupsResponse }
], { "google.api.default_host": "googleads.googleapis.com", "google.api.oauth_scopes": "https://www.googleapis.com/auth/adwords" });
//# sourceMappingURL=keyword_plan_ad_group_service.js.map