...
exports.AdGroupCriterionLabelService = exports.MutateAdGroupCriterionLabelResult = exports.MutateAdGroupCriterionLabelsResponse = exports.AdGroupCriterionLabelOperation = exports.MutateAdGroupCriterionLabelsRequest = void 0;
...
const ad_group_criterion_label_1 = require("../resources/ad_group_criterion_label");
// @generated message type with reflection information, may provide speed optimized methods
class MutateAdGroupCriterionLabelsRequest$Type extends runtime_5.MessageType {
    constructor() {
        super("google.ads.googleads.v11.services.MutateAdGroupCriterionLabelsRequest", [
            ...
            { no: 2, name: "operations", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => exports.AdGroupCriterionLabelOperation, options: { "google.api.field_behavior": ["REQUIRED"] } },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* repeated google.ads.googleads.v11.services.AdGroupCriterionLabelOperation operations */ 2:
                    message.operations.push(exports.AdGroupCriterionLabelOperation.internalBinaryRead(reader, reader.uint32(), options));
                    break;
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let i = 0; i < message.operations.length; i++)
            exports.AdGroupCriterionLabelOperation.internalBinaryWrite(message.operations[i], writer.tag(2, runtime_1.WireType.LengthDelimited).fork(), options).join();
 ...
 */
exports.MutateAdGroupCriterionLabelsRequest = new MutateAdGroupCriterionLabelsRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class AdGroupCriterionLabelOperation$Type extends runtime_5.MessageType {
    constructor() {
        super("google.ads.googleads.v11.services.AdGroupCriterionLabelOperation", [
            { no: 1, name: "create", kind: "message", oneof: "operation", T: () => ad_group_criterion_label_1.AdGroupCriterionLabel },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* google.ads.googleads.v11.resources.AdGroupCriterionLabel create */ 1:
                    message.operation = {
                        oneofKind: "create",
                        create: ad_group_criterion_label_1.AdGroupCriterionLabel.internalBinaryRead(reader, reader.uint32(), options, message.operation.create)
                    };
                    break;
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.operation.oneofKind === "create")
            ad_group_criterion_label_1.AdGroupCriterionLabel.internalBinaryWrite(message.operation.create, writer.tag(1, runtime_1.WireType.LengthDelimited).fork(), options).join();
        /* string remove = 2; */
 ...
 */
exports.AdGroupCriterionLabelOperation = new AdGroupCriterionLabelOperation$Type();
// @generated message type with reflection information, may provide speed optimized methods
class MutateAdGroupCriterionLabelsResponse$Type extends runtime_5.MessageType {
    constructor() {
        super("google.ads.googleads.v11.services.MutateAdGroupCriterionLabelsResponse", [
            ...
            { no: 2, name: "results", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => exports.MutateAdGroupCriterionLabelResult }
        ]);
    }
    create(value) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* repeated google.ads.googleads.v11.services.MutateAdGroupCriterionLabelResult results */ 2:
                    message.results.push(exports.MutateAdGroupCriterionLabelResult.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let i = 0; i < message.results.length; i++)
            exports.MutateAdGroupCriterionLabelResult.internalBinaryWrite(message.results[i], writer.tag(2, runtime_1.WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
 ...
 */
exports.MutateAdGroupCriterionLabelsResponse = new MutateAdGroupCriterionLabelsResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class MutateAdGroupCriterionLabelResult$Type extends runtime_5.MessageType {
    constructor() {
 ...
 */
exports.MutateAdGroupCriterionLabelResult = new MutateAdGroupCriterionLabelResult$Type();
/**
 * @generated ServiceType for protobuf service google.ads.googleads.v11.services.AdGroupCriterionLabelService
 */
exports.AdGroupCriterionLabelService = new runtime_rpc_1.ServiceType("google.ads.googleads.v11.services.AdGroupCriterionLabelService", [
    { name: "MutateAdGroupCriterionLabels", options: { "google.api.http": { post: "/v11/customers/{customer_id=*}/adGroupCriterionLabels:mutate", body: "*" }, "google.api.method_signature": ["customer_id,operations"] }, I: exports.MutateAdGroupCriterionLabelsRequest, O: exports.MutateAdGroupCriterionLabelsResponse }
], { "google.api.default_host": "googleads.googleapis.com", "google.api.oauth_scopes": "https://www.googleapis.com/auth/adwords" });
//# sourceMappingURL=ad_group_criterion_label_service.js.map