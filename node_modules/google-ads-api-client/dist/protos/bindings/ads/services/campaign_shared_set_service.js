...
exports.CampaignSharedSetService = exports.MutateCampaignSharedSetResult = exports.MutateCampaignSharedSetsResponse = exports.CampaignSharedSetOperation = exports.MutateCampaignSharedSetsRequest = void 0;
...
const campaign_shared_set_1 = require("../resources/campaign_shared_set");
const response_content_type_1 = require("../enums/response_content_type");
// @generated message type with reflection information, may provide speed optimized methods
class MutateCampaignSharedSetsRequest$Type extends runtime_5.MessageType {
    constructor() {
        super("google.ads.googleads.v11.services.MutateCampaignSharedSetsRequest", [
            ...
            { no: 2, name: "operations", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => exports.CampaignSharedSetOperation, options: { "google.api.field_behavior": ["REQUIRED"] } },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* repeated google.ads.googleads.v11.services.CampaignSharedSetOperation operations */ 2:
                    message.operations.push(exports.CampaignSharedSetOperation.internalBinaryRead(reader, reader.uint32(), options));
                    break;
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let i = 0; i < message.operations.length; i++)
            exports.CampaignSharedSetOperation.internalBinaryWrite(message.operations[i], writer.tag(2, runtime_1.WireType.LengthDelimited).fork(), options).join();
 ...
 */
exports.MutateCampaignSharedSetsRequest = new MutateCampaignSharedSetsRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class CampaignSharedSetOperation$Type extends runtime_5.MessageType {
    constructor() {
        super("google.ads.googleads.v11.services.CampaignSharedSetOperation", [
            { no: 1, name: "create", kind: "message", oneof: "operation", T: () => campaign_shared_set_1.CampaignSharedSet },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* google.ads.googleads.v11.resources.CampaignSharedSet create */ 1:
                    message.operation = {
                        oneofKind: "create",
                        create: campaign_shared_set_1.CampaignSharedSet.internalBinaryRead(reader, reader.uint32(), options, message.operation.create)
                    };
                    break;
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.operation.oneofKind === "create")
            campaign_shared_set_1.CampaignSharedSet.internalBinaryWrite(message.operation.create, writer.tag(1, runtime_1.WireType.LengthDelimited).fork(), options).join();
        /* string remove = 3; */
 ...
 */
exports.CampaignSharedSetOperation = new CampaignSharedSetOperation$Type();
// @generated message type with reflection information, may provide speed optimized methods
class MutateCampaignSharedSetsResponse$Type extends runtime_5.MessageType {
    constructor() {
        super("google.ads.googleads.v11.services.MutateCampaignSharedSetsResponse", [
            ...
            { no: 2, name: "results", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => exports.MutateCampaignSharedSetResult }
        ]);
    }
    create(value) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* repeated google.ads.googleads.v11.services.MutateCampaignSharedSetResult results */ 2:
                    message.results.push(exports.MutateCampaignSharedSetResult.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let i = 0; i < message.results.length; i++)
            exports.MutateCampaignSharedSetResult.internalBinaryWrite(message.results[i], writer.tag(2, runtime_1.WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
 ...
 */
exports.MutateCampaignSharedSetsResponse = new MutateCampaignSharedSetsResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class MutateCampaignSharedSetResult$Type extends runtime_5.MessageType {
    constructor() {
        super("google.ads.googleads.v11.services.MutateCampaignSharedSetResult", [
            ...
            { no: 2, name: "campaign_shared_set", kind: "message", T: () => campaign_shared_set_1.CampaignSharedSet }
        ]);
    }
    create(value) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* google.ads.googleads.v11.resources.CampaignSharedSet campaign_shared_set */ 2:
                    message.campaignSharedSet = campaign_shared_set_1.CampaignSharedSet.internalBinaryRead(reader, reader.uint32(), options, message.campaignSharedSet);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.campaignSharedSet)
            campaign_shared_set_1.CampaignSharedSet.internalBinaryWrite(message.campaignSharedSet, writer.tag(2, runtime_1.WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
 ...
 */
exports.MutateCampaignSharedSetResult = new MutateCampaignSharedSetResult$Type();
/**
 * @generated ServiceType for protobuf service google.ads.googleads.v11.services.CampaignSharedSetService
 */
exports.CampaignSharedSetService = new runtime_rpc_1.ServiceType("google.ads.googleads.v11.services.CampaignSharedSetService", [
    { name: "MutateCampaignSharedSets", options: { "google.api.http": { post: "/v11/customers/{customer_id=*}/campaignSharedSets:mutate", body: "*" }, "google.api.method_signature": ["customer_id,operations"] }, I: exports.MutateCampaignSharedSetsRequest, O: exports.MutateCampaignSharedSetsResponse }
], { "google.api.default_host": "googleads.googleapis.com", "google.api.oauth_scopes": "https://www.googleapis.com/auth/adwords" });
//# sourceMappingURL=campaign_shared_set_service.js.map