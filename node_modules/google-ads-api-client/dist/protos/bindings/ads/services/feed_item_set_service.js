...
exports.FeedItemSetService = exports.MutateFeedItemSetResult = exports.MutateFeedItemSetsResponse = exports.FeedItemSetOperation = exports.MutateFeedItemSetsRequest = void 0;
...
const feed_item_set_1 = require("../resources/feed_item_set");
const field_mask_1 = require("../../google/protobuf/field_mask");
// @generated message type with reflection information, may provide speed optimized methods
class MutateFeedItemSetsRequest$Type extends runtime_5.MessageType {
    constructor() {
        super("google.ads.googleads.v11.services.MutateFeedItemSetsRequest", [
            ...
            { no: 2, name: "operations", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => exports.FeedItemSetOperation, options: { "google.api.field_behavior": ["REQUIRED"] } },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* repeated google.ads.googleads.v11.services.FeedItemSetOperation operations */ 2:
                    message.operations.push(exports.FeedItemSetOperation.internalBinaryRead(reader, reader.uint32(), options));
                    break;
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let i = 0; i < message.operations.length; i++)
            exports.FeedItemSetOperation.internalBinaryWrite(message.operations[i], writer.tag(2, runtime_1.WireType.LengthDelimited).fork(), options).join();
 ...
 */
exports.MutateFeedItemSetsRequest = new MutateFeedItemSetsRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class FeedItemSetOperation$Type extends runtime_5.MessageType {
    constructor() {
        super("google.ads.googleads.v11.services.FeedItemSetOperation", [
            { no: 4, name: "update_mask", kind: "message", T: () => field_mask_1.FieldMask },
            { no: 1, name: "create", kind: "message", oneof: "operation", T: () => feed_item_set_1.FeedItemSet },
            { no: 2, name: "update", kind: "message", oneof: "operation", T: () => feed_item_set_1.FeedItemSet },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* google.ads.googleads.v11.resources.FeedItemSet create */ 1:
                    message.operation = {
                        oneofKind: "create",
                        create: feed_item_set_1.FeedItemSet.internalBinaryRead(reader, reader.uint32(), options, message.operation.create)
                    };
                    break;
                case /* google.ads.googleads.v11.resources.FeedItemSet update */ 2:
                    message.operation = {
                        oneofKind: "update",
                        update: feed_item_set_1.FeedItemSet.internalBinaryRead(reader, reader.uint32(), options, message.operation.update)
                    };
                    break;
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.operation.oneofKind === "create")
            feed_item_set_1.FeedItemSet.internalBinaryWrite(message.operation.create, writer.tag(1, runtime_1.WireType.LengthDelimited).fork(), options).join();
        /* google.ads.googleads.v11.resources.FeedItemSet update = 2; */
        if (message.operation.oneofKind === "update")
            feed_item_set_1.FeedItemSet.internalBinaryWrite(message.operation.update, writer.tag(2, runtime_1.WireType.LengthDelimited).fork(), options).join();
        /* string remove = 3; */
 ...
 */
exports.FeedItemSetOperation = new FeedItemSetOperation$Type();
// @generated message type with reflection information, may provide speed optimized methods
class MutateFeedItemSetsResponse$Type extends runtime_5.MessageType {
    constructor() {
        super("google.ads.googleads.v11.services.MutateFeedItemSetsResponse", [
            { no: 1, name: "results", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => exports.MutateFeedItemSetResult },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* repeated google.ads.googleads.v11.services.MutateFeedItemSetResult results */ 1:
                    message.results.push(exports.MutateFeedItemSetResult.internalBinaryRead(reader, reader.uint32(), options));
                    break;
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let i = 0; i < message.results.length; i++)
            exports.MutateFeedItemSetResult.internalBinaryWrite(message.results[i], writer.tag(1, runtime_1.WireType.LengthDelimited).fork(), options).join();
 ...
 */
exports.MutateFeedItemSetsResponse = new MutateFeedItemSetsResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class MutateFeedItemSetResult$Type extends runtime_5.MessageType {
    constructor() {
 ...
 */
exports.MutateFeedItemSetResult = new MutateFeedItemSetResult$Type();
/**
 * @generated ServiceType for protobuf service google.ads.googleads.v11.services.FeedItemSetService
 */
exports.FeedItemSetService = new runtime_rpc_1.ServiceType("google.ads.googleads.v11.services.FeedItemSetService", [
    { name: "MutateFeedItemSets", options: { "google.api.http": { post: "/v11/customers/{customer_id=*}/feedItemSets:mutate", body: "*" }, "google.api.method_signature": ["customer_id,operations"] }, I: exports.MutateFeedItemSetsRequest, O: exports.MutateFeedItemSetsResponse }
], { "google.api.default_host": "googleads.googleapis.com", "google.api.oauth_scopes": "https://www.googleapis.com/auth/adwords" });
//# sourceMappingURL=feed_item_set_service.js.map