...
exports.CustomizerAttributeService = exports.MutateCustomizerAttributeResult = exports.MutateCustomizerAttributesResponse = exports.CustomizerAttributeOperation = exports.MutateCustomizerAttributesRequest = void 0;
...
const customizer_attribute_1 = require("../resources/customizer_attribute");
const field_mask_1 = require("../../google/protobuf/field_mask");
const response_content_type_1 = require("../enums/response_content_type");
// @generated message type with reflection information, may provide speed optimized methods
class MutateCustomizerAttributesRequest$Type extends runtime_5.MessageType {
    constructor() {
        super("google.ads.googleads.v11.services.MutateCustomizerAttributesRequest", [
            ...
            { no: 2, name: "operations", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => exports.CustomizerAttributeOperation, options: { "google.api.field_behavior": ["REQUIRED"] } },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* repeated google.ads.googleads.v11.services.CustomizerAttributeOperation operations */ 2:
                    message.operations.push(exports.CustomizerAttributeOperation.internalBinaryRead(reader, reader.uint32(), options));
                    break;
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let i = 0; i < message.operations.length; i++)
            exports.CustomizerAttributeOperation.internalBinaryWrite(message.operations[i], writer.tag(2, runtime_1.WireType.LengthDelimited).fork(), options).join();
 ...
 */
exports.MutateCustomizerAttributesRequest = new MutateCustomizerAttributesRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class CustomizerAttributeOperation$Type extends runtime_5.MessageType {
    constructor() {
        super("google.ads.googleads.v11.services.CustomizerAttributeOperation", [
            ...
            { no: 1, name: "create", kind: "message", oneof: "operation", T: () => customizer_attribute_1.CustomizerAttribute },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* google.ads.googleads.v11.resources.CustomizerAttribute create */ 1:
                    message.operation = {
                        oneofKind: "create",
                        create: customizer_attribute_1.CustomizerAttribute.internalBinaryRead(reader, reader.uint32(), options, message.operation.create)
                    };
                    break;
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.operation.oneofKind === "create")
            customizer_attribute_1.CustomizerAttribute.internalBinaryWrite(message.operation.create, writer.tag(1, runtime_1.WireType.LengthDelimited).fork(), options).join();
        /* string remove = 2; */
 ...
 */
exports.CustomizerAttributeOperation = new CustomizerAttributeOperation$Type();
// @generated message type with reflection information, may provide speed optimized methods
class MutateCustomizerAttributesResponse$Type extends runtime_5.MessageType {
    constructor() {
        super("google.ads.googleads.v11.services.MutateCustomizerAttributesResponse", [
            { no: 1, name: "results", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => exports.MutateCustomizerAttributeResult },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* repeated google.ads.googleads.v11.services.MutateCustomizerAttributeResult results */ 1:
                    message.results.push(exports.MutateCustomizerAttributeResult.internalBinaryRead(reader, reader.uint32(), options));
                    break;
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let i = 0; i < message.results.length; i++)
            exports.MutateCustomizerAttributeResult.internalBinaryWrite(message.results[i], writer.tag(1, runtime_1.WireType.LengthDelimited).fork(), options).join();
 ...
 */
exports.MutateCustomizerAttributesResponse = new MutateCustomizerAttributesResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class MutateCustomizerAttributeResult$Type extends runtime_5.MessageType {
    constructor() {
        super("google.ads.googleads.v11.services.MutateCustomizerAttributeResult", [
            ...
            { no: 2, name: "customizer_attribute", kind: "message", T: () => customizer_attribute_1.CustomizerAttribute }
        ]);
    }
    create(value) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* google.ads.googleads.v11.resources.CustomizerAttribute customizer_attribute */ 2:
                    message.customizerAttribute = customizer_attribute_1.CustomizerAttribute.internalBinaryRead(reader, reader.uint32(), options, message.customizerAttribute);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.customizerAttribute)
            customizer_attribute_1.CustomizerAttribute.internalBinaryWrite(message.customizerAttribute, writer.tag(2, runtime_1.WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
 ...
 */
exports.MutateCustomizerAttributeResult = new MutateCustomizerAttributeResult$Type();
/**
 * @generated ServiceType for protobuf service google.ads.googleads.v11.services.CustomizerAttributeService
 */
exports.CustomizerAttributeService = new runtime_rpc_1.ServiceType("google.ads.googleads.v11.services.CustomizerAttributeService", [
    { name: "MutateCustomizerAttributes", options: { "google.api.http": { post: "/v11/customers/{customer_id=*}/customizerAttributes:mutate", body: "*" }, "google.api.method_signature": ["customer_id,operations"] }, I: exports.MutateCustomizerAttributesRequest, O: exports.MutateCustomizerAttributesResponse }
], { "google.api.default_host": "googleads.googleapis.com", "google.api.oauth_scopes": "https://www.googleapis.com/auth/adwords" });
//# sourceMappingURL=customizer_attribute_service.js.map