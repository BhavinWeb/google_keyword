...
exports.BiddingStrategyService = exports.MutateBiddingStrategyResult = exports.MutateBiddingStrategiesResponse = exports.BiddingStrategyOperation = exports.MutateBiddingStrategiesRequest = void 0;
...
const bidding_strategy_1 = require("../resources/bidding_strategy");
const field_mask_1 = require("../../google/protobuf/field_mask");
const response_content_type_1 = require("../enums/response_content_type");
// @generated message type with reflection information, may provide speed optimized methods
class MutateBiddingStrategiesRequest$Type extends runtime_5.MessageType {
    constructor() {
        super("google.ads.googleads.v11.services.MutateBiddingStrategiesRequest", [
            ...
            { no: 2, name: "operations", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => exports.BiddingStrategyOperation, options: { "google.api.field_behavior": ["REQUIRED"] } },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* repeated google.ads.googleads.v11.services.BiddingStrategyOperation operations */ 2:
                    message.operations.push(exports.BiddingStrategyOperation.internalBinaryRead(reader, reader.uint32(), options));
                    break;
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let i = 0; i < message.operations.length; i++)
            exports.BiddingStrategyOperation.internalBinaryWrite(message.operations[i], writer.tag(2, runtime_1.WireType.LengthDelimited).fork(), options).join();
 ...
 */
exports.MutateBiddingStrategiesRequest = new MutateBiddingStrategiesRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class BiddingStrategyOperation$Type extends runtime_5.MessageType {
    constructor() {
        super("google.ads.googleads.v11.services.BiddingStrategyOperation", [
            ...
            { no: 1, name: "create", kind: "message", oneof: "operation", T: () => bidding_strategy_1.BiddingStrategy },
            { no: 2, name: "update", kind: "message", oneof: "operation", T: () => bidding_strategy_1.BiddingStrategy },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* google.ads.googleads.v11.resources.BiddingStrategy create */ 1:
                    message.operation = {
                        oneofKind: "create",
                        create: bidding_strategy_1.BiddingStrategy.internalBinaryRead(reader, reader.uint32(), options, message.operation.create)
                    };
                    break;
                case /* google.ads.googleads.v11.resources.BiddingStrategy update */ 2:
                    message.operation = {
                        oneofKind: "update",
                        update: bidding_strategy_1.BiddingStrategy.internalBinaryRead(reader, reader.uint32(), options, message.operation.update)
                    };
                    break;
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.operation.oneofKind === "create")
            bidding_strategy_1.BiddingStrategy.internalBinaryWrite(message.operation.create, writer.tag(1, runtime_1.WireType.LengthDelimited).fork(), options).join();
        /* google.ads.googleads.v11.resources.BiddingStrategy update = 2; */
        if (message.operation.oneofKind === "update")
            bidding_strategy_1.BiddingStrategy.internalBinaryWrite(message.operation.update, writer.tag(2, runtime_1.WireType.LengthDelimited).fork(), options).join();
        /* string remove = 3; */
 ...
 */
exports.BiddingStrategyOperation = new BiddingStrategyOperation$Type();
// @generated message type with reflection information, may provide speed optimized methods
class MutateBiddingStrategiesResponse$Type extends runtime_5.MessageType {
    constructor() {
        super("google.ads.googleads.v11.services.MutateBiddingStrategiesResponse", [
            ...
            { no: 2, name: "results", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => exports.MutateBiddingStrategyResult }
        ]);
    }
    create(value) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* repeated google.ads.googleads.v11.services.MutateBiddingStrategyResult results */ 2:
                    message.results.push(exports.MutateBiddingStrategyResult.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let i = 0; i < message.results.length; i++)
            exports.MutateBiddingStrategyResult.internalBinaryWrite(message.results[i], writer.tag(2, runtime_1.WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
 ...
 */
exports.MutateBiddingStrategiesResponse = new MutateBiddingStrategiesResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class MutateBiddingStrategyResult$Type extends runtime_5.MessageType {
    constructor() {
        super("google.ads.googleads.v11.services.MutateBiddingStrategyResult", [
            ...
            { no: 2, name: "bidding_strategy", kind: "message", T: () => bidding_strategy_1.BiddingStrategy }
        ]);
    }
    create(value) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* google.ads.googleads.v11.resources.BiddingStrategy bidding_strategy */ 2:
                    message.biddingStrategy = bidding_strategy_1.BiddingStrategy.internalBinaryRead(reader, reader.uint32(), options, message.biddingStrategy);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.biddingStrategy)
            bidding_strategy_1.BiddingStrategy.internalBinaryWrite(message.biddingStrategy, writer.tag(2, runtime_1.WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
 ...
 */
exports.MutateBiddingStrategyResult = new MutateBiddingStrategyResult$Type();
/**
 * @generated ServiceType for protobuf service google.ads.googleads.v11.services.BiddingStrategyService
 */
exports.BiddingStrategyService = new runtime_rpc_1.ServiceType("google.ads.googleads.v11.services.BiddingStrategyService", [
    { name: "MutateBiddingStrategies", options: { "google.api.http": { post: "/v11/customers/{customer_id=*}/biddingStrategies:mutate", body: "*" }, "google.api.method_signature": ["customer_id,operations"] }, I: exports.MutateBiddingStrategiesRequest, O: exports.MutateBiddingStrategiesResponse }
], { "google.api.default_host": "googleads.googleapis.com", "google.api.oauth_scopes": "https://www.googleapis.com/auth/adwords" });
//# sourceMappingURL=bidding_strategy_service.js.map