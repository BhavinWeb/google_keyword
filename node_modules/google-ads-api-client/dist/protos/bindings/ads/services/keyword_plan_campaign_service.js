...
exports.KeywordPlanCampaignService = exports.MutateKeywordPlanCampaignResult = exports.MutateKeywordPlanCampaignsResponse = exports.KeywordPlanCampaignOperation = exports.MutateKeywordPlanCampaignsRequest = void 0;
...
const keyword_plan_campaign_1 = require("../resources/keyword_plan_campaign");
const field_mask_1 = require("../../google/protobuf/field_mask");
// @generated message type with reflection information, may provide speed optimized methods
class MutateKeywordPlanCampaignsRequest$Type extends runtime_5.MessageType {
    constructor() {
        super("google.ads.googleads.v11.services.MutateKeywordPlanCampaignsRequest", [
            ...
            { no: 2, name: "operations", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => exports.KeywordPlanCampaignOperation, options: { "google.api.field_behavior": ["REQUIRED"] } },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* repeated google.ads.googleads.v11.services.KeywordPlanCampaignOperation operations */ 2:
                    message.operations.push(exports.KeywordPlanCampaignOperation.internalBinaryRead(reader, reader.uint32(), options));
                    break;
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let i = 0; i < message.operations.length; i++)
            exports.KeywordPlanCampaignOperation.internalBinaryWrite(message.operations[i], writer.tag(2, runtime_1.WireType.LengthDelimited).fork(), options).join();
 ...
 */
exports.MutateKeywordPlanCampaignsRequest = new MutateKeywordPlanCampaignsRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class KeywordPlanCampaignOperation$Type extends runtime_5.MessageType {
    constructor() {
        super("google.ads.googleads.v11.services.KeywordPlanCampaignOperation", [
            ...
            { no: 1, name: "create", kind: "message", oneof: "operation", T: () => keyword_plan_campaign_1.KeywordPlanCampaign },
            { no: 2, name: "update", kind: "message", oneof: "operation", T: () => keyword_plan_campaign_1.KeywordPlanCampaign },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* google.ads.googleads.v11.resources.KeywordPlanCampaign create */ 1:
                    message.operation = {
                        oneofKind: "create",
                        create: keyword_plan_campaign_1.KeywordPlanCampaign.internalBinaryRead(reader, reader.uint32(), options, message.operation.create)
                    };
                    break;
                case /* google.ads.googleads.v11.resources.KeywordPlanCampaign update */ 2:
                    message.operation = {
                        oneofKind: "update",
                        update: keyword_plan_campaign_1.KeywordPlanCampaign.internalBinaryRead(reader, reader.uint32(), options, message.operation.update)
                    };
                    break;
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.operation.oneofKind === "create")
            keyword_plan_campaign_1.KeywordPlanCampaign.internalBinaryWrite(message.operation.create, writer.tag(1, runtime_1.WireType.LengthDelimited).fork(), options).join();
        /* google.ads.googleads.v11.resources.KeywordPlanCampaign update = 2; */
        if (message.operation.oneofKind === "update")
            keyword_plan_campaign_1.KeywordPlanCampaign.internalBinaryWrite(message.operation.update, writer.tag(2, runtime_1.WireType.LengthDelimited).fork(), options).join();
        /* string remove = 3; */
 ...
 */
exports.KeywordPlanCampaignOperation = new KeywordPlanCampaignOperation$Type();
// @generated message type with reflection information, may provide speed optimized methods
class MutateKeywordPlanCampaignsResponse$Type extends runtime_5.MessageType {
    constructor() {
        super("google.ads.googleads.v11.services.MutateKeywordPlanCampaignsResponse", [
            ...
            { no: 2, name: "results", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => exports.MutateKeywordPlanCampaignResult }
        ]);
    }
    create(value) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* repeated google.ads.googleads.v11.services.MutateKeywordPlanCampaignResult results */ 2:
                    message.results.push(exports.MutateKeywordPlanCampaignResult.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let i = 0; i < message.results.length; i++)
            exports.MutateKeywordPlanCampaignResult.internalBinaryWrite(message.results[i], writer.tag(2, runtime_1.WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
 ...
 */
exports.MutateKeywordPlanCampaignsResponse = new MutateKeywordPlanCampaignsResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class MutateKeywordPlanCampaignResult$Type extends runtime_5.MessageType {
    constructor() {
 ...
 */
exports.MutateKeywordPlanCampaignResult = new MutateKeywordPlanCampaignResult$Type();
/**
 * @generated ServiceType for protobuf service google.ads.googleads.v11.services.KeywordPlanCampaignService
 */
exports.KeywordPlanCampaignService = new runtime_rpc_1.ServiceType("google.ads.googleads.v11.services.KeywordPlanCampaignService", [
    { name: "MutateKeywordPlanCampaigns", options: { "google.api.http": { post: "/v11/customers/{customer_id=*}/keywordPlanCampaigns:mutate", body: "*" }, "google.api.method_signature": ["customer_id,operations"] }, I: exports.MutateKeywordPlanCampaignsRequest, O: exports.MutateKeywordPlanCampaignsResponse }
], { "google.api.default_host": "googleads.googleapis.com", "google.api.oauth_scopes": "https://www.googleapis.com/auth/adwords" });
//# sourceMappingURL=keyword_plan_campaign_service.js.map