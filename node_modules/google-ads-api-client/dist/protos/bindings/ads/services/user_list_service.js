...
exports.UserListService = exports.MutateUserListResult = exports.MutateUserListsResponse = exports.UserListOperation = exports.MutateUserListsRequest = void 0;
...
const user_list_1 = require("../resources/user_list");
const field_mask_1 = require("../../google/protobuf/field_mask");
// @generated message type with reflection information, may provide speed optimized methods
class MutateUserListsRequest$Type extends runtime_5.MessageType {
    constructor() {
        super("google.ads.googleads.v11.services.MutateUserListsRequest", [
            ...
            { no: 2, name: "operations", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => exports.UserListOperation, options: { "google.api.field_behavior": ["REQUIRED"] } },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* repeated google.ads.googleads.v11.services.UserListOperation operations */ 2:
                    message.operations.push(exports.UserListOperation.internalBinaryRead(reader, reader.uint32(), options));
                    break;
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let i = 0; i < message.operations.length; i++)
            exports.UserListOperation.internalBinaryWrite(message.operations[i], writer.tag(2, runtime_1.WireType.LengthDelimited).fork(), options).join();
 ...
 */
exports.MutateUserListsRequest = new MutateUserListsRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class UserListOperation$Type extends runtime_5.MessageType {
    constructor() {
        super("google.ads.googleads.v11.services.UserListOperation", [
            { no: 4, name: "update_mask", kind: "message", T: () => field_mask_1.FieldMask },
            { no: 1, name: "create", kind: "message", oneof: "operation", T: () => user_list_1.UserList },
            { no: 2, name: "update", kind: "message", oneof: "operation", T: () => user_list_1.UserList },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* google.ads.googleads.v11.resources.UserList create */ 1:
                    message.operation = {
                        oneofKind: "create",
                        create: user_list_1.UserList.internalBinaryRead(reader, reader.uint32(), options, message.operation.create)
                    };
                    break;
                case /* google.ads.googleads.v11.resources.UserList update */ 2:
                    message.operation = {
                        oneofKind: "update",
                        update: user_list_1.UserList.internalBinaryRead(reader, reader.uint32(), options, message.operation.update)
                    };
                    break;
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.operation.oneofKind === "create")
            user_list_1.UserList.internalBinaryWrite(message.operation.create, writer.tag(1, runtime_1.WireType.LengthDelimited).fork(), options).join();
        /* google.ads.googleads.v11.resources.UserList update = 2; */
        if (message.operation.oneofKind === "update")
            user_list_1.UserList.internalBinaryWrite(message.operation.update, writer.tag(2, runtime_1.WireType.LengthDelimited).fork(), options).join();
        /* string remove = 3; */
 ...
 */
exports.UserListOperation = new UserListOperation$Type();
// @generated message type with reflection information, may provide speed optimized methods
class MutateUserListsResponse$Type extends runtime_5.MessageType {
    constructor() {
        super("google.ads.googleads.v11.services.MutateUserListsResponse", [
            ...
            { no: 2, name: "results", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => exports.MutateUserListResult }
        ]);
    }
    create(value) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* repeated google.ads.googleads.v11.services.MutateUserListResult results */ 2:
                    message.results.push(exports.MutateUserListResult.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let i = 0; i < message.results.length; i++)
            exports.MutateUserListResult.internalBinaryWrite(message.results[i], writer.tag(2, runtime_1.WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
 ...
 */
exports.MutateUserListsResponse = new MutateUserListsResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class MutateUserListResult$Type extends runtime_5.MessageType {
    constructor() {
 ...
 */
exports.MutateUserListResult = new MutateUserListResult$Type();
/**
 * @generated ServiceType for protobuf service google.ads.googleads.v11.services.UserListService
 */
exports.UserListService = new runtime_rpc_1.ServiceType("google.ads.googleads.v11.services.UserListService", [
    { name: "MutateUserLists", options: { "google.api.http": { post: "/v11/customers/{customer_id=*}/userLists:mutate", body: "*" }, "google.api.method_signature": ["customer_id,operations"] }, I: exports.MutateUserListsRequest, O: exports.MutateUserListsResponse }
], { "google.api.default_host": "googleads.googleapis.com", "google.api.oauth_scopes": "https://www.googleapis.com/auth/adwords" });
//# sourceMappingURL=user_list_service.js.map