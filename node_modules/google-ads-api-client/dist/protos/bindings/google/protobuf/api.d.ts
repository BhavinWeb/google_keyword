...
declare class Api$Type extends MessageType<Api> {
    constructor();
 ...
 */
export declare const Api: Api$Type;
declare class Method$Type extends MessageType<Method> {
    constructor();
 ...
 */
export declare const Method: Method$Type;
declare class Mixin$Type extends MessageType<Mixin> {
    constructor();
 ...
 */
export declare const Mixin: Mixin$Type;
export {};
