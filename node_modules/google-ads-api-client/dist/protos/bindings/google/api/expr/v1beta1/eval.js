...
exports.IdRef = exports.UnknownSet = exports.ErrorSet = exports.ExprValue = exports.EvalState_Result = exports.EvalState = void 0;
...
class EvalState_Result$Type extends runtime_5.MessageType {
    constructor() {
        super("google.api.expr.v1beta1.EvalState.Result", [
            { no: 1, name: "expr", kind: "message", T: () => exports.IdRef },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* google.api.expr.v1beta1.IdRef expr */ 1:
                    message.expr = exports.IdRef.internalBinaryRead(reader, reader.uint32(), options, message.expr);
                    break;
                case /* int32 value */ 2:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.expr)
            exports.IdRef.internalBinaryWrite(message.expr, writer.tag(1, runtime_1.WireType.LengthDelimited).fork(), options).join();
        /* int32 value = 2; */
        if (message.value !== 0)
...
class UnknownSet$Type extends runtime_5.MessageType {
    constructor() {
        super("google.api.expr.v1beta1.UnknownSet", [
            { no: 1, name: "exprs", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => exports.IdRef }
        ]);
    }
    create(value) {
        const message = { exprs: [] };
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* repeated google.api.expr.v1beta1.IdRef exprs */ 1:
                    message.exprs.push(exports.IdRef.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let i = 0; i < message.exprs.length; i++)
            exports.IdRef.internalBinaryWrite(message.exprs[i], writer.tag(1, runtime_1.WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
// @generated message type with reflection information, may provide speed optimized methods
class IdRef$Type extends runtime_5.MessageType {
    constructor() {
