...
declare class DeclType$Type extends MessageType<DeclType> {
    constructor();
 ...
 */
export declare const DeclType: DeclType$Type;
declare class IdentDecl$Type extends MessageType<IdentDecl> {
    constructor();
 ...
 */
export declare const IdentDecl: IdentDecl$Type;
declare class FunctionDecl$Type extends MessageType<FunctionDecl> {
    constructor();
 ...
 */
export declare const FunctionDecl: FunctionDecl$Type;
export {};
