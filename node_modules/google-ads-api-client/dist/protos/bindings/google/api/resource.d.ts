...
declare class ResourceDescriptor$Type extends MessageType<ResourceDescriptor> {
    constructor();
 ...
 */
export declare const ResourceDescriptor: ResourceDescriptor$Type;
declare class ResourceReference$Type extends MessageType<ResourceReference> {
    constructor();
 ...
 */
export declare const ResourceReference: ResourceReference$Type;
export {};
